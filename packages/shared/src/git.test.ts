...
describe("normalizeGitRemoteUrl", () => {
  it("canonicalizes equivalent GitHub remotes across protocol variants", () => {
    expect(normalizeGitRemoteUrl("git@github.com:T3Tools/TxCode.git")).toBe(
      "github.com/t3tools/txcode",
    );
    expect(normalizeGitRemoteUrl("https://github.com/T3Tools/TxCode.git")).toBe(
      "github.com/t3tools/txcode",
    );
    expect(normalizeGitRemoteUrl("ssh://git@github.com/T3Tools/TxCode")).toBe(
      "github.com/t3tools/txcode",
    );
  });

  it("preserves nested group paths for providers like GitLab", () => {
    expect(normalizeGitRemoteUrl("git@gitlab.com:T3Tools/platform/TxCode.git")).toBe(
      "gitlab.com/t3tools/platform/txcode",
    );
    expect(normalizeGitRemoteUrl("https://gitlab.com/T3Tools/platform/TxCode.git")).toBe(
      "gitlab.com/t3tools/platform/txcode",
    );
  });
...
describe("parseGitHubRepositoryNameWithOwnerFromRemoteUrl", () => {
  it("extracts the owner and repository from common GitHub remote shapes", () => {
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("git@github.com:T3Tools/TxCode.git"),
    ).toBe("T3Tools/TxCode");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("https://github.com/T3Tools/TxCode.git"),
    ).toBe("T3Tools/TxCode");
  });
});
