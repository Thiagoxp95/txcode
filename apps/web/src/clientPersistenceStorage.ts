...
export const CLIENT_SETTINGS_STORAGE_KEY = "txcode:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "txcode:saved-environment-registry:v1";
